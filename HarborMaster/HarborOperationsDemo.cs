...
namespace HarborMaster
{
  ...
  /// dalam sistem HarborMaster (Windows Forms compatible)
  /// </summary>
...
Console.WriteLine("=== SERVICE MANAGEMENT DEMO ===\n");
   ...
   /// <summary>
        ...
        /// </summary>
        public Invoice ProcessShipArrival(Ship ship, Berth berth, List<PortServiceBase> requestedServices)
        {
            ...
            foreach (var service in requestedServices)
{
 ...
 // 4. Generate Invoice
            ...
            foreach (var service in requestedServices)
 {
        // Note: We'll need to add a method to add services to invoice
   ...
   public void RunCompleteScenario()
{
  ...
  // Setup berths
            var berth1 = new Berth { Id = "B1", BerthID = "B1", Location = "North Dock", Capacity = 100000 };
   var berth2 = new Berth { Id = "B2", BerthID = "B2", Location = "South Dock", Capacity = 150000 };
var berth3 = new Berth { Id = "B3", BerthID = "B3", Location = "East Dock", Capacity = 80000 };
            ...
            var hazmatServices = new List<PortServiceBase>
            {
   ...
   new CargoHandlingService("CARGO-H1", 800, 35000, "Special Crane") { RequiresSpecialHandling = true },
    ...
    var cruiseServices = new List<PortServiceBase>
    {
 ...
 Console.WriteLine("\n--- SCENARIO 3: LNG Tanker ---");
      ...
      var tankerServices = new List<PortServiceBase>
      {
...
/// Method untuk mendemonstrasikan encapsulation dengan validation
      ...
      try
  {
   ...
   Console.WriteLine($"? Validation prevented invalid tonnage: {ex.Message}");
            ...
            catch (Exception ex)
    {
        ...
        /// <summary>
        /// Demo method untuk Windows Forms - bisa dipanggil dari form
    /// </summary>
 ...
 Console.SetOut(writer);
           ...
           try
          {
 DemonstrateDockingFeeCalculation();
 Console.WriteLine("\n" + new string('=', 60) + "\n");
